...
AntiSpamBot
V 4.7
Programmer By @Ar3min
*/
define('API_KEY','662871534:AAEuUGE_ztgCZZM1zLLv9KHcLhgWQNqUKM8');//addtoken
//-----------------------------------------------------------------------------------------
//فانکشن MrPHPBot :
...
$token = '711964380:AAFYo9VWQ1GxPAjZUhRqsnF-sEW_AJVWLBw';//add token
...
if($textmassage=="/start" && $tc == "private"){
  sendAction($chat_id, 'typing');
	MrPHPBot('sendmessage',[
	'chat_id'=>$chat_id,
	'text'=>"درود من محافظ گروه شما هستم برای فعال سازی من باید از ادمینم بخواین در گروهتون فعال کنه ربات رو",
	]);
	}
 //groupmanager
...
['text'=>"برگشت",'callback_data'=>'back']
  ...
  elseif($data=="back" && $fm == $owners2){
   ...
   [
['text'=>"📌کانال ما📌",'url'=>"https://telegram.me/"]
  ],
    ]
    ])
    ]);
...
['text'=>"📌کانال ما📌",'url'=>"https://telegram.me/"]
    ...
    elseif($data=="help" && $fm == $owners2){
     ...
     'message_id'=>$messageid,
             ...
             *➖➖➖➖➖➖*
             >راهنمای حذف پیام
             *[/]rmsg [Number]* ➖ (حذف پیام به تعداد معین (بین 0 و7000))
             *➖➖➖➖➖➖*
...
save("data/$chat_id/welcome.txt","Welcome NewMember To Group");
SendMessage($chat_id,"`ربات رو گروه فعال شد💎` \n لطفا دیگه این `دستور` را تکرار نکنید⚙️\n *Version* _1.3_");
}
}
...
elseif ($textmassage == "/unlock flood" && $from_id == $Dev) {
if ($tc == 'group' | $tc == 'supergroup'){
save("data/$chat_id/lockflood.txt","✖️");
SendMessage($chat_id,"`انجام شد🔈`");
}
...
elseif ($textmassage == "/unlock bots" && $from_id == $Dev) {
if ($tc == 'group' | $tc == 'supergroup'){
save("data/$chat_id/lockbots.txt","✖️");
SendMessage($chat_id,"`انجام شد🔈`");
}
...
➖➖➖
[🌟@BESTinMUSIC🌟](https://telegram.me/)"],
            'reply_markup' => [
                'inline_keyboard' => [
                    [
                        ['text' => "عضویت در ربات", 'url' => 'https://telegram.me/']
                    ],
                    [
